  ...
  browser: ['Bot By Xion','Safari','1.0.0'],
  auth: state
  })
  ...
  // Welcome / Leave
  if (anu.action == 'add') {
  tekswell = `Hai Oni-Chan @${num.split('@')[0]} 👋\nSelamat Datang Di Grup ${metadata.subject}\n\n`
  let btnwel = [{buttonId: 'Riy', buttonText: {displayText: 'Welcome Oni-Chan 👋'}, type: 1},]
  ...
  let btnbye = [{buttonId: 'Riy', buttonText: {displayText: 'Goodbye Oni-Chan 👋'}, type: 1},]
